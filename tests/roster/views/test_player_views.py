...
class TestPlayerViewSet(TestBase):
    ...
    def test_list_throttles_for_anonymous_user(
        self, api_client, player_list_url, teams
    ):
        response_1 = api_client.get(player_list_url)
        response_2 = api_client.get(player_list_url)
        response_3 = api_client.get(player_list_url)
    ...
    def test_list_throttles_for_general_user(
        self, api_client, player_list_url, teams, general_user
    ):
        api_client.force_authenticate(user=general_user)
    ...
    def test_list_throttles_for_admin_user(
        self, api_client, player_list_url, teams, admin_user
    ):
        api_client.force_authenticate(user=admin_user)
